<div class="bg-black text-white relative">
  ...
  <main class="bg-[40%_14%] bg-no-repeat object-contain bg-main-blob">
    ...
    <header class="text-white h-screen w-screen flex items-center z-20">
      <div class="container mx-auto text-center">
        ...
        <h1 class="text-4xl font-bold mb-4">Reliable Courier Services</h1>
  ...
  <section class="text-white py-36">
    <div class="container mx-auto text-center">

      <h2 class="text-4xl font-bold mb-8">Efficient Courier Solutions</h2>
