<div id="menu" class="z-20 w-3/12 h-[85vh] max-w-xs">
  <div class="bg-neutral-950 h-full rounded-tr-lg rounded-br-lg p-4 relative
    ...
    ">
    <a href="<?php echo BasePath ?>/dashboard" class="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 justify-center items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
      <div class="flex flex-col space-y-2 space-x-2 md:flex-row md:space-y-0 justify-center items-center">
        ...
        <p class="font-bold text-base lg:text-lg text-slate-200">Account</p>
      </div>
    </a>
