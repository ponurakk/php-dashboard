    ...
    <div>
      ...
      <div class="mt-2 relative">
        ...
        <select id="courier_department" name="courier_department" class="block w-full rounded-md border-0 py-1.5 text-gray-900 sm:text-lg sm:leading-6 focus:outline-none pl-9">
          ...
          <option value="3">Operations Department</option>
          <option value="4">Marketing Department</option>
        </select>
      </div>
    </div>

    <input type="button" id="addCourier" class="bg-white bg-no-repeat px-6 py-3 font-bold text-black w-1/2 justify-center rounded-lg bg-primary-linear transition-all duration-300 ease-out bg-[length:200%] text-xl bg-[200%] hover:bg-[100%] clickable hover:text-white" value="Submit">
  </form>
</div>
